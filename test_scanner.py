...
def test_get_symbol(new_names, new_scanner):
    i = 0
    desired_output = [[3, 16], [0, 0], [1, 22], [0, 13], [0, 10], [3, 17],
    [3, 16], [0, 0], [1, 23], [1, 24], [1, 25], [0, 14], [0, 4], [2, 0],
    [3, 17], [3, 16], [0, 0], [1, 26], [0, 13], [0, 3], [2, 1], [3, 17],
    [3, 16], [0, 1], [1, 23], [0, 15], [1, 22], [3, 18], [1, 27], [3, 17],
    [3, 16], [0, 1], [1, 24], [0, 15], [1, 22], [3, 18], [1, 28], [3, 17],
    [3, 16], [0, 1], [1, 25], [0, 15], [1, 22], [3, 18], [1, 29], [3, 17],
    [3, 16], [0, 1], [1, 26], [0, 15], [1, 22], [3, 18], [1, 30], [3, 17],
    [3, 16], [0, 2], [1, 26], [3, 17]]
    ...
    assert new_scanner.get_symbol() == [5, 1]
